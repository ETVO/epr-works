    ...
    <>
      <div className="flex flex-col gap-6">
        <div>
          ...
          <sub className='text-base'>Portfolio, Resume and Education</sub>
        </div>
        ...
        <p className='text-sm text-gray-500'>
          <a className='hover-underline text-gold' target='_blank' href="" download>Download my CV</a>
        </p>
      </div>
    </>
  )
...
export default function App() {
  ...
  return (
    <div className="App flex pt-24 pb-10">
